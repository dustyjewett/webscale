...
function WebScale(deviceIndex, vendor, product) {
  this._prevWeight = null;
  this._vendor = vendor || VENDOR_ID;
  this._product = product || PRODUCT_ID;
...
WebScale.prototype._connect = function () {
  var devices = HID.devices(this._vendor, this._product);
